...
export default {
  ...
  mainSliderImages: [
    `${IMAGE_PATHS.STATIC}main_slider/21..jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/B_1_01.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/B_2_15.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_AA_48_StyleRevolver.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_AD_32_Monvelli.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_AG_15_Trusthaven.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_AK_03_pawxie.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_L_09_lush.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_P_42_Avanti.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_S_25_Autovity.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_W_33_Quantic.jpg`,
    `${IMAGE_PATHS.STATIC}main_slider/Banner_Visual_Name_Y_29_Vechetti.jpg`,
  ],
  exampleSliderImages: [
    `${IMAGE_PATHS.STATIC}example_slider/1.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/2.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/3.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/4.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/5.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/6.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/7.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/8.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/9.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/10.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/11.jpg`,
    `${IMAGE_PATHS.STATIC}example_slider/12.jpg`,
  ],
  feedbackSliderImages: [
    `${IMAGE_PATHS.STATIC}feedback_slider/Blue dress professional Lynne Lowder-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/Bonnie Linked-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/IMG_0232-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/me (5)-avatar.jpeg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/MoonFamily web size-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/nathan2-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/Simon-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/squad-avatar.jpg`,
    `${IMAGE_PATHS.STATIC}feedback_slider/Unbenannt1-avatar.jpg`,
  ],
  EXAMPLE_SLIDER_TEXT: [
    'vib.io',
    'Exactly.com',
